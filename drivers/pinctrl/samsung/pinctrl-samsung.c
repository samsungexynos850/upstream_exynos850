...
static int __init exynos850_secgpio_get_nr_gpio(void)
{
	unsigned int i, j;
	int nr_gpio = 0;
	const struct samsung_pin_ctrl *pin_ctrl = exynos3830_of_data.ctrl;
	unsigned int num_ctrl = exynos3830_of_data.num_ctrl;
